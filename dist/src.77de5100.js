...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../../../.nvm/versions/node/v12.2.0/lib/node_modules/parcel/node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
},{}],"../../../../.nvm/versions/node/v12.2.0/lib/node_modules/parcel/node_modules/ieee754/index.js":[function(require,module,exports) {
...
},{}],"../../../../.nvm/versions/node/v12.2.0/lib/node_modules/parcel/node_modules/isarray/index.js":[function(require,module,exports) {
...
},{}],"../../../../.nvm/versions/node/v12.2.0/lib/node_modules/parcel/node_modules/buffer/index.js":[function(require,module,exports) {
...
},{"base64-js":"../../../../.nvm/versions/node/v12.2.0/lib/node_modules/parcel/node_modules/base64-js/index.js","ieee754":"../../../../.nvm/versions/node/v12.2.0/lib/node_modules/parcel/node_modules/ieee754/index.js","isarray":"../../../../.nvm/versions/node/v12.2.0/lib/node_modules/parcel/node_modules/isarray/index.js","buffer":"../../../../.nvm/versions/node/v12.2.0/lib/node_modules/parcel/node_modules/buffer/index.js"}],"../node_modules/parsimmon/build/parsimmon.umd.min.js":[function(require,module,exports) {
var define;
...
},{"buffer":"../../../../.nvm/versions/node/v12.2.0/lib/node_modules/parcel/node_modules/buffer/index.js"}],"lambda.ts":[function(require,module,exports) {
"use strict";
...
exports.succ = "(\\wyx.y(wyx))";
exports.zero = "(\\sz.z)";

exports.add = function (a, b) {
  return a + "(\\mnfx.mf(nfx))" + b;
};

exports.interpret = function (s) {
  return evaluate(parse(s));
};

function evaluate(expr) {
  var gen = evaluateGen(expr);
  var result;
  var next = gen.next();
...
function evaluateGen(expr) {
  var t, done, result, top, topContext;
  return __generator(this, function (_a) {
    switch (_a.label) {
      ...
      case 2:
        ...
        /*break*/
        , 8];
        if (!isLambda(t.current)) return [3
        /*break*/
        , 6];
        if (!t.rightSibling) return [3
        /*break*/
        , 4];
        result = bind(t.current, t.rightSibling);
        t.up();
        t.current = result;
        top = void 0;
        topContext = t.contexts[0];
      ...
      case 6:
        ...
        if (done && t.contexts.length) {
          while (!t.stack.length && t.contexts.length) {
            t.exitScope();
          }

          if (!t.contexts.length) return [3
          /*break*/
          , 8];
          done = false;
        }
...
exports.evaluateGen = evaluateGen;

var Traverser =
/** @class */
function () {
  function Traverser(expr) {
    this.contexts = [];
    this._current = expr;
    this.stack = [];
    this.contexts = [];
  ...
  Object.defineProperty(Traverser.prototype, "current", {
    get: function get() {
    ...
    set: function set(expr) {
      this._current = expr;
      var above;
      if (this.stack[0]) above = last(this.stack);else {
      ...
      if (above) {
        if (above.branchToNext == "left") above.ap.a = expr;else above.ap.b = expr;
      }
    },
    enumerable: true,
    configurable: true
  });
  Object.defineProperty(Traverser.prototype, "rightSibling", {
    get: function get() {
  ...
  Traverser.prototype.left = function () {
  ...
  Traverser.prototype.right = function () {
    if (isApplication(this.current)) {
      this.stack.push({
        ap: this.current,
        branchToNext: "right"
  ...
  Traverser.prototype.up = function () {
    var above = this.stack.pop();
  ...
  Traverser.prototype.enterScope = function () {
  ...
  Traverser.prototype.exitScope = function () {
    var outer = this.contexts.pop();
...
/** @class */
function (_super) {
  __extends(DepthFirst, _super);

  function DepthFirst() {
    return _super !== null && _super.apply(this, arguments) || this;
  }

  DepthFirst.prototype.forward = function () {
    if (isApplication(this.current)) this.left();else {
      var above = last(this.stack);
...
function bind(lambda, expr) {
  function replaceInExpression(current) {
    if (typeof current == "string") {
      return current == lambda.head ? expr : current;
    } else if (isApplication(current)) {
      return newApplication(replaceInExpression(current.a), replaceInExpression(current.b));
    } else {
      if (current.head == lambda.head) {
        return current;
      } else {
        return newLambda(current.head, replaceInExpression(current.body));
      }
    }
  }
...
exports.bind = bind; // printing

function print(expr) {
  if (typeof expr == "string") return expr;else if (isLambda(expr)) return "\\" + expr.head + "." + print(expr.body);else {
    var a = print(expr.a),
        b = print(expr.b);
...
var Lang = P.createLanguage({
  Term: function Term(r) {
    return r.Application.or(r.Lambda);
  },
  Lambda: function Lambda(r) {
    return P.seq(P.oneOf('\\'), r.Name.atLeast(1), P.oneOf('.'), r.Term).map(function (result) {
      var names = result[1];
      return names.reduceRight(function (acc, name) {
        return {
          kind: 'l',
          head: name,
          body: acc
  ...
  Application: function Application(r) {
    return r.Atom.atLeast(1).map(function (atoms) {
  ...
  Atom: function Atom(r) {
    return P.alt(r.Term.wrap(P.string('('), P.string(')')), r.Name, r.Lambda);
  }
}); // helpers
...
},{"parsimmon":"../node_modules/parsimmon/build/parsimmon.umd.min.js"}],"../node_modules/d3/dist/package.js":[function(require,module,exports) {
"use strict";
...
var L = __importStar(require("./lambda"));

var d3 = __importStar(require("d3"));

var body = d3.select("body");
var div = body.append("div");
div.style("text-align", "center").style("position", "relative").style("top", "50%").style("transform", "translateY(50%)").style("-webkit-transform", "translateY(50%)").style("-ms-transform", "translateY(50%)").append("input").attr("type", "text").attr("id", "expression").on("input", checkSyntax);
var expr = d3.select("#expression").on("change", function () {
  return showEvaluated(expr.property("value"), "#result");
});
div.append("div").attr("id", "result").style("width", "100%").style("height", "500px").style("overflow", "auto");

function showEvaluated(expr, element) {
  var e_1, _a;

  var output = d3.select(element).selectAll("div");
  var results = [];

  try {
    var gen = L.evaluateGen(L.parse(expr));

    try {
      for (var gen_1 = __values(gen), gen_1_1 = gen_1.next(); !gen_1_1.done; gen_1_1 = gen_1.next()) {
        var expr_1 = gen_1_1.value;
        results.push(L.print(expr_1));
      }
    } catch (e_1_1) {
      e_1 = {
        error: e_1_1
  ...
  output.data(results).join("div").text(function (d) {
    return d;
  });
}

function checkSyntax() {
  var input = d3.select("#expression");
...
},{"./lambda":"lambda.ts","d3":"../node_modules/d3/index.js"}],"../../../../.nvm/versions/node/v12.2.0/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../.nvm/versions/node/v12.2.0/lib/node_modules/parcel/src/builtins/hmr-runtime.js","index.ts"], null)
